...
const mockSucursal: SucursalForm = {
...
export default function EditarSucursalPage() {
  ...
  const [formData, setFormData] = useState<SucursalForm>(mockSucursal)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      router.push(`/cliente/sucursales/${sucursalId}`)
    }, 1000)
  }
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="flex items-center space-x-4">
        <Link
          href={`/cliente/sucursales/${sucursalId}`}
        ...
        <div>
          ...
          <p className="text-gray-600">Modifica los datos de la sucursal</p>
        </div>
      </div>
